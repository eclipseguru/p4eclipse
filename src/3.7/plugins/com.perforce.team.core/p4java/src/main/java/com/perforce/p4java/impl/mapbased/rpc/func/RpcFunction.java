...
public class RpcFunction {
	...
	private static final RpcFunctionMetadata[] functionMetadata = {
			...
			new RpcFunctionMetadata(RpcFunctionSpec.PROTOCOL_ECHO, RpcFunctionType.PROTOCOL, "echo"),
			new RpcFunctionMetadata(RpcFunctionSpec.PROTOCOL_ERRORHANDLER, RpcFunctionType.PROTOCOL, "errorHandler"),
			...
			new RpcFunctionMetadata(RpcFunctionSpec.PROTOCOL_FUNCHANDLER, RpcFunctionType.PROTOCOL, "funcHandler"),
			...
			new RpcFunctionMetadata(RpcFunctionSpec.USER_ADMIN, RpcFunctionType.USER, "user-admin"),
			...
			new RpcFunctionMetadata(RpcFunctionSpec.USER_FLUSH, RpcFunctionType.USER, "user-flush"),
			...
			new RpcFunctionMetadata(RpcFunctionSpec.USER_HEARTBEAT, RpcFunctionType.USER, "user-heartbeat"),
			new RpcFunctionMetadata(RpcFunctionSpec.USER_HELP, RpcFunctionType.USER, "user-help"),
			new RpcFunctionMetadata(RpcFunctionSpec.USER_INFO, RpcFunctionType.USER, "user-info"),
			new RpcFunctionMetadata(RpcFunctionSpec.USER_INTEGRATE, RpcFunctionType.USER, "user-integrate"),
			...
			new RpcFunctionMetadata(RpcFunctionSpec.USER_PUSH, RpcFunctionType.USER, "user-push"),
			new RpcFunctionMetadata(RpcFunctionSpec.USER_RECONCILE, RpcFunctionType.USER, "user-reconcile"),
			new RpcFunctionMetadata(RpcFunctionSpec.USER_REMOTE, RpcFunctionType.USER, "user-remote"),
			new RpcFunctionMetadata(RpcFunctionSpec.USER_REMOTES, RpcFunctionType.USER, "user-remotes"),
			new RpcFunctionMetadata(RpcFunctionSpec.USER_RENAME, RpcFunctionType.USER, "user-rename"),
			...
			new RpcFunctionMetadata(RpcFunctionSpec.USER_RESUBMIT, RpcFunctionType.USER, "user-resubmit"),
			...
			new RpcFunctionMetadata(RpcFunctionSpec.USER_SET, RpcFunctionType.USER, "user-set"),
			...
			new RpcFunctionMetadata(RpcFunctionSpec.USER_STREAMSPEC, RpcFunctionType.USER, "user-streamspec"),
			new RpcFunctionMetadata(RpcFunctionSpec.USER_SUBMIT, RpcFunctionType.USER, "user-submit"),
			new RpcFunctionMetadata(RpcFunctionSpec.USER_SWITCH, RpcFunctionType.USER, "user-switch"),
			...
			new RpcFunctionMetadata(RpcFunctionSpec.USER_TYPEMAP, RpcFunctionType.USER, "user-typemap"),
			new RpcFunctionMetadata(RpcFunctionSpec.USER_UNDO, RpcFunctionType.USER, "user-undo"),
			new RpcFunctionMetadata(RpcFunctionSpec.USER_UNLOCK, RpcFunctionType.USER, "user-unlock"),
			new RpcFunctionMetadata(RpcFunctionSpec.USER_UNSUBMIT, RpcFunctionType.USER, "user-unsubmit"),
			new RpcFunctionMetadata(RpcFunctionSpec.USER_UNZIP, RpcFunctionType.USER, "user-unzip"),
			...
			new RpcFunctionMetadata(RpcFunctionSpec.USER_ZIP, RpcFunctionType.USER, "user-zip"),
			...
			new RpcFunctionMetadata(RpcFunctionSpec.CLIENT_ACKMATCH, RpcFunctionType.CLIENT, "client-AckMatch"),
			new RpcFunctionMetadata(RpcFunctionSpec.CLIENT_ACTIONRESOLVE, RpcFunctionType.CLIENT, "client-ActionResolve"),
			...
			new RpcFunctionMetadata(RpcFunctionSpec.CLIENT_CLOSEDIFF, RpcFunctionType.CLIENT, "client-CloseDiff"),
			new RpcFunctionMetadata(RpcFunctionSpec.CLIENT_CLOSEFILE, RpcFunctionType.CLIENT, "client-CloseFile"),
			new RpcFunctionMetadata(RpcFunctionSpec.CLIENT_CLOSEMATCH, RpcFunctionType.CLIENT, "client-CloseMatch"),
			new RpcFunctionMetadata(RpcFunctionSpec.CLIENT_CLOSEMERGE, RpcFunctionType.CLIENT, "client-CloseMerge"),
			new RpcFunctionMetadata(RpcFunctionSpec.CLIENT_CONVERTFILE, RpcFunctionType.CLIENT, "client-ConvertFile"),
			...
			new RpcFunctionMetadata(RpcFunctionSpec.CLIENT_EDITDATA, RpcFunctionType.CLIENT, "client-EditData"),
			new RpcFunctionMetadata(RpcFunctionSpec.CLIENT_ERRORPAUSE, RpcFunctionType.CLIENT, "client-ErrorPause"),
			new RpcFunctionMetadata(RpcFunctionSpec.CLIENT_FSTATINFO, RpcFunctionType.CLIENT, "client-FstatInfo"),
			new RpcFunctionMetadata(RpcFunctionSpec.CLIENT_FSTATPARTIAL, RpcFunctionType.CLIENT, "client-FstatPartial"),
			new RpcFunctionMetadata(RpcFunctionSpec.CLIENT_HANDLEERROR, RpcFunctionType.CLIENT, "client-HandleError"),
			...
			new RpcFunctionMetadata(RpcFunctionSpec.CLIENT_OPENMATCH, RpcFunctionType.CLIENT, "client-OpenMatch"),
			...
			new RpcFunctionMetadata(RpcFunctionSpec.CLIENT_OPENURL, RpcFunctionType.CLIENT, "client-OpenUrl"),
			...
			new RpcFunctionMetadata(RpcFunctionSpec.CLIENT_PING, RpcFunctionType.CLIENT, "client-Ping"),
			...
			new RpcFunctionMetadata(RpcFunctionSpec.CLIENT_EXACTMATCH, RpcFunctionType.CLIENT, "client-ExactMatch"),
			new RpcFunctionMetadata(RpcFunctionSpec.CLIENT_SCANDIR, RpcFunctionType.CLIENT, "client-ScanDir"),
			...
			new RpcFunctionMetadata(RpcFunctionSpec.CLIENT_WRITEDIFF, RpcFunctionType.CLIENT, "client-WriteDiff"),
			new RpcFunctionMetadata(RpcFunctionSpec.CLIENT_WRITEFILE, RpcFunctionType.CLIENT, "client-WriteFile"),
			new RpcFunctionMetadata(RpcFunctionSpec.CLIENT_WRITEMATCH, RpcFunctionType.CLIENT, "client-WriteMatch"),
