...
public class RpcFunctionMapKey {
	...
	public static final String CHECKLINKS = "checkLinks";
	public static final String CHECKLINKSN = "checkLinksN";
	...
	public static final String DEPOTTIME = "depotTime";
	public static final String DEPOTREC = "depotRec"; // Server state pass-through
	public static final String DEPOT_DIRS = "depotDirs";
	public static final String DEPOT_FILE = "depotFile";
	public static final String DEPOT_FILES = "depotFiles";
	...
	public static final String PENDINGDIGEST = "pendingDigest";
	...
	public static final String RACTIONMERGE = "rActionMerge";
	public static final String RACTIONTHEIRS = "rActionTheirs";
	public static final String RACTIONTYPE = "rActionType";
	public static final String RACTIONYOURS = "rActionYours";
	public static final String RAUTORESULT = "rAutoResult";
	...
	public static final String RESOLVE_BASE_FILE = "resolveBaseFile";
	public static final String RESOLVE_FROM_FILE = "resolveFromFile";
	public static final String RESOLVE_BASE_REV = "resolveBaseRev";
	public static final String RESOLVE_START_FROM_REV = "resolveStartFromRev";
	public static final String RESOLVE_END_FROM_REV = "resolveEndFromRev";
	...
	public static final String ROPTAUTO = "rOptAuto";
	public static final String ROPTHELP = "rOptHelp";
	public static final String ROPTMERGE = "rOptMerge";
	public static final String ROPTSKIP = "rOptSkip";
	public static final String ROPTTHEIRS = "rOptTheirs";
	public static final String ROPTYOURS = "rOptYours";
	public static final String RPROMPTMERGE = "rPromptMerge";
	public static final String RPROMPTTHEIRS = "rPromptTheirs";
	public static final String RPROMPTTYPE = "rPromptType";
	public static final String RPROMPTYOURS = "rPromptYours";
	public static final String RUSERERROR = "rUserError";
	public static final String RUSERHELP = "rUserHelp";
	public static final String RUSERPROMPT = "rUserPrompt";
	...
	public static final String SKIP_CURRENT = "skipCurrent";
	public static final String SKIPDIGESTCHECK = "skipDigestCheck";
