...
public class P4VStreamsAction extends P4VAction {
     ...
     */
    public StreamsRunner[] runApplication() {
        P4Collection collection = super.getResourceSelection();
        List<StreamsRunner> runners = new ArrayList<StreamsRunner>();
        ...
        return runners.toArray(new StreamsRunner[0]);
    }
