...
public class PerforceStringMatcher {
    ...
    /**
     * A string pattern matcher, suppporting * and ? wildcards. Note: code
     * copied from org.eclipse.jdt.internal.core.util.StringMatcher on April 3,
     * 2001 (version 0.1 - 010901H18 [rename jbl]).
     * 
     * Copied in turn from the Eclipse original, but only because we can't
     * access the underlying versions from the plugin reliably until everyone
     * has 3.3...
     */
    ...
    public PerforceStringMatcher.Position find(String text, int start, int end) {
     ...
     * 
     * @param aPattern
     *            the pattern to match text with
     * @param ignoreCase
     ...
     */
    public PerforceStringMatcher(String aPattern, boolean ignoreCase,
