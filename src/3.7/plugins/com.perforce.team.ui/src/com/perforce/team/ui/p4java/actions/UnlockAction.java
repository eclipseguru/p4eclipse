 ...
 */
public class UnlockAction extends P4Action {
    ...
    private void unlock(final P4Collection collection) {
        IP4Runnable runnable = new P4Runnable() {

            @Override
            public String getTitle() {
                return Messages.UnlockAction_Unlocking;
            }
                ...
                if (size > 0) {
                    for (IP4Resource resource : resources) {
                        if (resource instanceof IP4File) {
                            ...
                            if (file.isOpened() && file.isLocked()) {
                                enabled = true;
                                break;
                            }
                        } else {
