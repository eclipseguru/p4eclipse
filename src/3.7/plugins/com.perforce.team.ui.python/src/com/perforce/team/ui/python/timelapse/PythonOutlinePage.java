...
import com.perforce.team.ui.python.PerforceUiPythonPlugin;
 ...
 * 
 */
public class PythonOutlinePage extends NodeOutlinePage {
    ...
    /**
     * Python tree content provider
     */
    private class PythonTreeContentProvider implements ITreeContentProvider {
     ...
     * @param model
     */
    public PythonOutlinePage(IModelElement root, INodeModel model) {
        super(root, model);
    }
    ...
    private void configureToolbar(final TreeViewer viewer,
        ...
        Action sort = new Action(Messages.PythonOutlinePage_Sort,
            ...
            public void run() {
                ...
                PerforceUiPythonPlugin.getDefault().getPreferenceStore()
                        .setValue(SORT, isChecked());
            }
        };
        sort.setToolTipText(Messages.PythonOutlinePage_Sort);
        manager.add(sort);
        sort.setChecked(PerforceUiPythonPlugin.getDefault()
                .getPreferenceStore().getBoolean(SORT));
        sort.run();
    }
    ...
    protected ITreeContentProvider getContentProvider() {
        return new PythonTreeContentProvider();
    }
    ...
    protected IBaseLabelProvider getLabelProvider() {
        return new DecoratingStyledCellLabelProvider(new NodeLabelProvider(
                PythonUtils.createLabelProvider()), new ILabelDecorator() {
