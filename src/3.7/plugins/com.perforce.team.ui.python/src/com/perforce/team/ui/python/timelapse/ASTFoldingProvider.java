...
public abstract class ASTFoldingProvider implements IFoldingStructureProvider,
    ...
    public static final class FoldingStructureComputationContext {
        ...
        protected LinkedHashMap<ScriptProjectionAnnotation, Position> fMap = new LinkedHashMap<ScriptProjectionAnnotation, Position>();
    ...
    public ASTFoldingProvider(ProjectionViewer viewer, ProjectionSupport support) {
        ...
        this.fStore = PythonUtils.createCombinedPreferenceStore();
    }
    ...
    private void update(FoldingStructureComputationContext ctx) {
        ...
        if (!folded.comments.isEmpty() || !folded.nonComments.isEmpty()) {
            checkCollapse(updates, folded.nonComments, folded.nonComments);
            ...
            checkCollapse(Arrays.asList(adds), folded.comments, folded.nonComments);
        }
