 ...
 * 
 */
public class Cp1251Test extends UnicodeTestCase {
    ...
    protected String getRawPath() {
        return "//depot/charset_files/Windows 1251/always_cp1251.txt";
    }
    ...
    protected String getTranslatePath() {
        return "//depot/charset_files/Windows 1251/translated.txt";
    }
