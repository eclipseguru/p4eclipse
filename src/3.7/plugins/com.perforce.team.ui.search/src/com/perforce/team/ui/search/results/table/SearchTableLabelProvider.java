 ...
 */
public class SearchTableLabelProvider extends LabelProviderAdapter {
     ...
     * @param display
     */
    public SearchTableLabelProvider(ISearchResultProvider page, Display display) {
        this.page = page;
    ...
    private StyledString getFileMatchText(IP4File file) {
        ...
        styled.append(MessageFormat.format(
                Messages.SearchTableLabelProvider_NumRevisions, matches),
    ...
    private StyledString getRevisionMatchText(RevisionMatch revision) {
        ...
        styled.append(MessageFormat.format(
                Messages.SearchTableLabelProvider_NumMatches, matches),
                StyledString.COUNTER_STYLER);
        return styled;
    }
